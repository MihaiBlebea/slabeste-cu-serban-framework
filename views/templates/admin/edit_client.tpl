    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <hr />
                {if isset($user)}
                <form action="{$app_path}/client/update-client" method="POST">
                {else}
                <form action="{$app_path}/client/post-create-client" method="POST">
                {/if}
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="owned-tags" name="accounts" style="resize: none;" rows="4" fixed>{$user['programs']|default:''}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <a href="{$app_path}/client/clients" class="card-link">Back to clients</a><br />
                    </div>
                    <div class="col">
                        {if isset($user)}
                            <a href="{$app_path}/client/delete-client/{$user['id']}" class="card-link" style="color:red;float: right;">Delete client</a><br />
                        {/if}
                    </div>
                <div class="row">
            </div>
