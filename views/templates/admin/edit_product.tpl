    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <hr />
                <form action="{$app_path}/product/post-product" method="POST">
                    <div class="row">
                        <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <a href="{$app_path}/product/products" class="card-link">Back to products</a><br />
                    </div>
                    <div class="col">
                        <a href="{$app_path}/product/delete-product/{$program['id']}" class="card-link" style="color:red;float: right;">Delete program</a><br />
                    </div>
                <div class="row">
            </div>
        </div>
