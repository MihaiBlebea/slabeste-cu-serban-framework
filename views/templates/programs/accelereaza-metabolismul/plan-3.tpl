                    ...
                    <div class="row">
                        <div class="col p-3">
                            <a href="http://www.slabestecuserban.ro/wp-content/uploads/2015/08/Saptamana-III-Plan-De-Accelerare-A-Metabolismului.pdf">
                                <img class="card-img-top download-card-img" src="{$app_path}/img/accelereaza-metabolismul/plan_saptamana_3.png">
                            </a>
                        </div>
                        <div class="col">
                            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col p-3">
                            <a href="http://www.slabestecuserban.ro/wp-content/uploads/2015/08/Lista-de-cumparaturi-Saptamana-III_2.pdf">
                                <img class="card-img-top download-card-img" src="{$app_path}/img/accelereaza-metabolismul/cumparaturi_saptamana_3.png">
                            </a>
                        </div>
                        <div class="col">
                            <div class="card-body">
