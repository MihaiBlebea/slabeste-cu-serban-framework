    ...
    <div class="row">
        <div class="jumbotron">
            <div class="program-section">
                ...
                <p class="lead">Antrenamentele din a doua saptamana combina exercitiile special pentru abdomen cu...</p>
                <hr class="my-4">

                <div class="card mb-4">
                    <div class="row">
                        <div class="col p-3">
                            <a href="{$app_path}/ebooks/talie-mai-subtire/plan_antrenament_sapt_2.pdf">
                        ...
                        <div class="col">
                            <div class="card-body">
                                ...
                                <a href="{$app_path}/ebooks/talie-mai-subtire/plan_antrenament_sapt_2.pdf" class="btn btn-primary">Descarca</a>
                            </div>
                        </div>
                    </div>
                </div>
