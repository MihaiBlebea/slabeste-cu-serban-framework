                    ...
                    <div class="col">
                        <div class="card" style="width: 20rem;">
                            <a href="http://www.slabestecuserban.ro/wp-content/uploads/2016/07/PLAN-DE-ALIMENTATIE-SAPTAMANA-I.pdf">
                                <img class="card-img-top download-card-img" src="{$app_path}/img/talie-mai-subtire/nutritie-saptamana-1.png">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card" style="width: 20rem;">
                            <a href="http://www.slabestecuserban.ro/wp-content/uploads/2016/07/Lista-de-cumparaturi_saptamana-I_Talie-Mai-subtire.pdf">
                                <img class="card-img-top download-card-img" src="{$app_path}/img/talie-mai-subtire/cumparaturi-saptamana-1.png">
                            </a>
                            <div class="card-body">
